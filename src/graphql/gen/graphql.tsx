...
export type LoginResponse = {
  ...
  statusCode: Scalars['Int'];
  statusIsOk?: Maybe<Scalars['Boolean']>;
  statusMessage: Scalars['String'];
  statusPath: Scalars['String'];
...
export type Mutation_Root = {
  ...
  change_password?: Maybe<ChangePasswordResponse>;
...
export type LoginMutation = { __typename?: 'mutation_root', login?: { __typename?: 'LoginResponse', statusCode: number, statusPath: string, statusMessage: string, statusIsOk?: boolean | null, token: string } | null };
...
export type ChangePasswordMutation = { __typename?: 'mutation_root', changePassword?: { __typename?: 'ChangePasswordResponse', statusCode: number, statusPath: string, statusIsOk: boolean, statusMessage: string } | null };
...
export type PublishPostMutation = { __typename?: 'mutation_root', updatePost?: { __typename?: 'posts', id: number } | null };
...
export type RegisterMutation = { __typename?: 'mutation_root', register?: { __typename?: 'RegisterResponse', statusCode: string, statusPath: string, statusMessage: string, statusIsOk: boolean, token?: string | null } | null };
...
export type UpdatePersonalInfoMutation = { __typename?: 'mutation_root', updateUser?: { __typename?: 'users', id: number } | null };
...
export type GetUserByPkSubscriptionVariables = Exact<{
  userId: Scalars['Int'];
}>;


export type GetUserByPkSubscription = { __typename?: 'subscription_root', userByPk?: { __typename?: 'users', id: number, name: string, email: string, role: string, createdAt?: any | null, profilePicture?: string | null } | null };
...
export const ChangePasswordDocument = gql`
  ...
  changePassword: change_password(data: $data) {
    statusCode
    statusPath
    statusIsOk
    statusMessage
...
export const UpdatePersonalInfoDocument = gql`
    mutation updatePersonalInfo($userId: Int!, $data: users_set_input!) {
  updateUser: update_users_by_pk(pk_columns: {id: $userId}, _set: $data) {
    id
  }
}
    `;
...
export const GetUserByPkDocument = gql`
    subscription getUserByPk($userId: Int!) {
  userByPk: users_by_pk(id: $userId) {
    ...UserFields
  }
}
...
/**
 * __useGetUserByPkSubscription__
 *
 * To run a query within a React component, call `useGetUserByPkSubscription` and pass it any options that fit your needs.
 * When your component renders, `useGetUserByPkSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserByPkSubscription({
 *   variables: {
 *      userId: // value for 'userId'
 *   },
 * });
 */
export function useGetUserByPkSubscription(baseOptions: Apollo.SubscriptionHookOptions<GetUserByPkSubscription, GetUserByPkSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetUserByPkSubscription, GetUserByPkSubscriptionVariables>(GetUserByPkDocument, options);
      }
export type GetUserByPkSubscriptionHookResult = ReturnType<typeof useGetUserByPkSubscription>;
export type GetUserByPkSubscriptionResult = Apollo.SubscriptionResult<GetUserByPkSubscription>;